...
parser = Lark.open(
    "grammar/glue_field_type_grammar.lark", rel_to=__file__, parser="lalr", start="type"
)
...
def map_column(
    raw_column_data: Dict[str, Any], oddrn_generator: GlueGenerator, stats: DataSetField
) -> List[DataSetField]:
    try:
