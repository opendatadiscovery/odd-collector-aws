...
endpoint_node = {'EndpointIdentifier': 'database-1id', 'EndpointType': 'SOURCE', 'EngineName': 'sqlserver',
                 'EngineDisplayName': 'Microsoft SQL Server', 'Username': 'admin',
                 'ServerName': 'database-1.cs2rwctroxbf.eu-west-2.rds.amazonaws.com', 'Port': 1433,
                 'DatabaseName': 'test_db', 'Status': 'active',
                 'KmsKeyId': 'arn:aws:kms:eu-west-2:245260513500:key/a802067a-e288-441f-b63f-a7ecb5b783f4',
                 'EndpointArn': 'arn:aws:dms:eu-west-2:245260513500:endpoint:7DRJ5QSHOPBBCAYW76EA6SHZXMBCCV67XHPML4Y',
                 'SslMode': 'none', 'MicrosoftSQLServerSettings': {'Port': 1433, 'DatabaseName': 'test_db',
