...
class MetadataExtractor:
    ...
    __preprocessing: Dict[str, Callable] = {"Parameters::exclusions": json.loads}
    ...
    def extract_dataset_metadata(self, data: Dict[str, Any]) -> Dict[str, Any]:
        return {
            ...
            "metadata": self.__extract_all_entries(
                data, exclude=self.__dataset_excludes
            ),
        }
    ...
    def extract_dashboard_metadata(self, data: Dict[str, Any]) -> Dict[str, Any]:
        return {
            "schema_url": (
                f"{SCHEMA_FILE_URL}#/definitions/QuickSightDashboardExtension"
            ),
            "metadata": self.__extract_all_entries(
                data, exclude=self.__dashboard_excludes
            ),
        }
    ...
    def extract_analysis_metadata(self, data: Dict[str, Any]) -> Dict[str, Any]:
        return {
            ...
            "metadata": self.__extract_all_entries(
                data, exclude=self.__analysis_excludes
            ),
        }
    ...
    def extract_data_sources_metadata(self, data: Dict[str, Any]) -> Dict[str, Any]:
        return {
            "schema_url": (
                f"{SCHEMA_FILE_URL}#/definitions/QuickSightDataSourcesExtension"
            ),
            "metadata": self.__extract_all_entries(
                data, exclude=self.__data_source_excludes
            ),
        }
