...
class S3SchemaRetriever:
    ...
    def __set_ds(self, path: str, ext):
        self.__data = ds.dataset(
            path, filesystem=self.__fs, format=ext, partitioning=self.__partitioning
        )
    ...
    def __extract_all_entries(self, data, path: str, ext) -> Dict[str, Any]:
        entries = {}
